...
export const translations: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    analysisSwitchSuggestionUseModel: "Use this model",
    ...
    carbs: "Carbs",
    fat: "Fat",
    saveFix: "Apply correction and add to future instructions",
    applyFixTodayOnly: "Apply correction to this measurement only",
    saveFixShort: "Save",
    saveFixTable: "Apply correction and add to future instructions",
    applyFixTodayOnlyTable: "Apply correction to this measurement only",
    kcalPer100gHeader: "kcal/100g",
    estimatedValue: "Estimated",
    kcalPer100gLabel: "kcal/100g",
    unitKcal: "kcal",
    unitG: "g",
    unitKg: "kg",
    unitCm: "cm",
  ...
  he: {
    ...
    analysisSwitchSuggestionUseModel: "להשתמש במודל הזה",
    ...
    carbs: "פחמימות",
    fat: "שומן",
    saveFix: "החל תיקון והוסף להוראות לעתיד",
    applyFixTodayOnly: "החל תיקון למדידה הזו בלבד",
    saveFixShort: "שמור",
    saveFixTable: "החל תיקון והוסף להוראות לעתיד",
    applyFixTodayOnlyTable: "החל תיקון למדידה הזו בלבד",
    kcalPer100gHeader: "kcal/100g",
    estimatedValue: "מוערך",
    kcalPer100gLabel: "קלוריות ל-100 גרם",
    unitKcal: "קלוריות",
    unitG: "גרם",
    unitKg: "ק\"ג",
    unitCm: "ס\"מ",
