...
export const translations: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    applyFixTodayOnly: "Apply fix (today only)",
    saveFixShort: "Save",
    saveFixTable: "Apply fix and save to instructions",
  ...
  he: {
    ...
    fat: "שומן",
    saveFix: "שמור להבא",
    applyFixTodayOnly: "החל תיקון להיום",
    saveFixShort: "שמור",
    saveFixTable: "החל תיקון והוסף להוראות",
